      ...
      >
        ...
        >
          <div class="flex w-full items-center justify-between space-x-6 p-6">
            ...
            <img class="h-10 w-10 flex-shrink-0 rounded-full bg-gray-300" :src="user.imageUrl" alt="" />
            <PencilSquareIcon
...
import { ExclamationTriangleIcon,TrashIcon, PencilSquareIcon } from "@heroicons/vue/24/outline";
