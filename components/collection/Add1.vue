...
var emit =  defineEmits(['add_units'])
...
const addTemplate = (data: any) => {
  ...
  metric: propertyMetric.value,
  build_up_area: 0,
  security_deposit: 0,
  expected_price: 0,
  price_per_square_feet: 0,
  remarks: "string",
  default_image_url: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",
  visit_count: 0,
  approve_status: "Active",
  listing_status: "Available",
  location_hub: "Mall",
  location_near: "Entrance",
  entrance_width: 0,
  ceiling_height: 0,
  carpet_area: 0,
  no_of_bedrooms: 0,
  ...
  covered_parking: 0,
  open_parking: 0,
  age_of_property: propertyAge.value,
  ownership: "Freehold",
  rent_amount: 0,
  lead_id: propertyLeadId.value,
